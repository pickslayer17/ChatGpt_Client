namespace ChatGpt_Client.Models
{
    ...
    {
        private const string MainChatInstructions = $"Ты чат с двойной задачей. 1) ведение хронологии 2) жесткий объективный разъебывающий чат\r\n" +
        ...
        private const string HiddenChatInstruction = "- Краткий лаконичный пересказ по КАЖДОМУ сообщению(учитывать сообщения и пользователя и чатагпт) чата начиная с первого в переписке (НЕЛЬЗЯ нарушать этот пункт, это может стоить комуто жизни )\r\n- Твой основной ответ\r\nТы НЕ имеешь права менять смысл сказанного ранее. Ты ОБЯЗАН следовать этой структуре в каждом сообщении. Любое отклонение недопустимо.\r\n\n";
